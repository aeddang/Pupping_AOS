package com.raftgroup.pupping.scene.page.explore.component
...
class UserMap : PageComponent {
    ...
    fun initializaMap(rootView: View, savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync { map ->
            ...
            currentMap?.setOnMarkerClickListener (GoogleMap.OnMarkerClickListener { mk->
                if (mk.rotation == 0.0f){
                    (mk.tag as? User)?.let {
