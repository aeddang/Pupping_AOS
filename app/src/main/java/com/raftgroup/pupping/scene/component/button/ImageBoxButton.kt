...
open class ImageBoxButton : PageUI {
    ...
    override fun onInit() {
        super.onInit()
        binding = UiImageBoxButtonBinding.inflate(LayoutInflater.from(context), this, true)
    }
    ...
    override var selected:Boolean? = null
        set(value) {
            ...
            dfColor?.let { color ->
                ...
                else binding.text.setTextColor( context.getColor(R.color.app_white) )
            }
            ...
            dfColor?.let { color ->
                if ( field == false) {
                    ...
                    binding.body.setBackgroundColor(context.getColor(R.color.app_white))
                }
                else {
                    binding.imageIcon.setColorFilter(context.getColor(R.color.app_white))
                    binding.body.setBackgroundColor(acColor ?: color)
                }
            }
